...
const std::vector<Video> VideoLibrary::getVideos() const {
...
const Video VideoLibrary::getVideoByTitle(const std::string& videoTitle) const {
...
const Video VideoLibrary::getVideoById(const std::string& videoId) const {
  for (const auto& video : getVideos()) {
